const { Category, User, Role, Product, Purchase, Company, Supplier } = require('../models');
...
const purchaseExistById = async( id = '') =>{
    const purchaseExists = await Purchase.findById(id);
